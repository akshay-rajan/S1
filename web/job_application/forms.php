		...
		<form method="post" action="job_application.php">
			<table border=1 align="center" width="60%">
				...
				<tr>
					...
					<td>
						<input type="checkbox" name="mal" value="Malayalam">Malayalam</input>
						<input type="checkbox" name="eng" value="English">English</input>
						<input type="checkbox" name="hin" value="Hindi">Hindi</input>
					</td>
				</tr>
				<tr>
					<td>Phone number</td>
